...
import { expandKeywords } from "../services/geminiService.js";
...
export async function scrapeLeads(req, res, next) {
  ...
  try {
    ...
    const expandedKeywords = await expandKeywords(parsedBody.keywords, parsedBody.region);
    ...
    const enrichedLeads = await enrichLeads(leadsWithEmails);
